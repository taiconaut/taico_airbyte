...
import pytest
from source_adform.source import AdformStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AdformStream, "path", "v0/example_endpoint")
    mocker.patch.object(AdformStream, "primary_key", "test_primary_key")
    mocker.patch.object(AdformStream, "__abstractmethods__", set())
