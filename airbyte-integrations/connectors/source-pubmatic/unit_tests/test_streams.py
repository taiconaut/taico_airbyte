...
import pytest
from source_pubmatic.source import PubmaticStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(PubmaticStream, "path", "v0/example_endpoint")
    mocker.patch.object(PubmaticStream, "primary_key", "test_primary_key")
    mocker.patch.object(PubmaticStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = PubmaticStream()
